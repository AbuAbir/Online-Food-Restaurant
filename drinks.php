...
?>
    <p>&nbsp;</p>
    <?php
    $sqlb = "SELECT * FROM `food_info` WHERE `food_category` = 'drinks'";
  ...
  <div class="product">
    ...
    <button class="cart_button" name="cart_name" onclick="showUser(this.value)" value="<?php echo $row['food_id']; ?>">order</button><br />
     ...
     ?>
  <div class="product-thumb" style="margin-right:500px;" id="space"><img height="400" width="400" src="<?php echo $row['image_link'] ?>" />
    <br/>
